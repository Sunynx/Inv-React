...
export default function AssetDetailsPage() {
  ...
  if (mode === 'view') {
    ...
    return (
      <div className="min-h-screen bg-background text-foreground flex flex-col">
        ...
        <div className="flex-1 w-full max-w-7xl mx-auto flex flex-col transition-colors duration-300">
          <div className="p-6 pb-5 border-b border-border bg-muted/10 rounded-t-xl mt-4 mx-4 sm:mx-6 lg:mx-8 shadow-sm">
          ...
          <div className="p-6 mx-4 sm:mx-6 lg:mx-8 mb-8 space-y-8 flex-1 bg-card rounded-b-xl border border-t-0 shadow-sm">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <div className="flex-1 w-full max-w-7xl mx-auto flex flex-col transition-colors duration-300">
        <div className="p-6 pb-5 border-b border-border bg-muted/10 rounded-t-xl mt-4 mx-4 sm:mx-6 lg:mx-8 shadow-sm">
          <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-foreground">{assetId ? 'แก้ไขข้อมูลอุปกรณ์' : 'เพิ่มอุปกรณ์ใหม่'}</h2>
          {assetId && <p className="text-sm font-medium text-muted-foreground mt-1">กำลังแก้ไข: {assetData?.name || 'Unknown Asset'}</p>}
        </div>

        <div className="p-6 mx-4 sm:mx-6 lg:mx-8 mb-8 flex-1 bg-card rounded-b-xl border border-t-0 shadow-sm relative">
          {isLoadingAsset || isLoadingLookups ? (
        ...
        <div className="p-4 border-t border-border bg-background mt-auto flex justify-end gap-3 shrink-0 shadow-sm z-10 sticky bottom-0">
          <Button type="button" variant="outline" onClick={() => {
            if (assetId) setMode('view');
            else router.push('/assets');
          }} className="w-24">ยกเลิก</Button>
